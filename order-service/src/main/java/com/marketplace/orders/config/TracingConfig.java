 ...
 * in this project's exact combination of dependencies and versions: a {@code Propagation.Factory}
 * that actually understands W3C {@code traceparent}/{@code tracestate}.
 *
 ...
 * forever, which is exactly the kind of silent failure this project's constitution asks to be found
 ...
 * {@code brave-propagation-tracecontext} — a library that was already on the classpath
 * transitively (see this module's {@code pom.xml}) but had never been reachable through Boot's own
 * configuration path.
 */
@Configuration
